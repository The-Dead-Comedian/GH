...
public class WysteriaBlock extends Block {
	public static final DirectionProperty FACING = HorizontalDirectionalBlock.FACING;

	public WysteriaBlock() {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(GardenheavenModBlocks.WYSTERIA.get(), renderType -> renderType == RenderType.cutout());
	}
}
